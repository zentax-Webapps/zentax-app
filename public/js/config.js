// =====================================================================
// Zentax Work Flow - frontend config
// Fill in the two values below from your Supabase project's API settings:
//   Project Settings → API → "Project URL" and "anon public" key.
// These two values are SAFE to be in client-side code — they are
// public-facing keys. Row Level Security in the database enforces all
// permissions on the server. NEVER put the service_role key here.
// =====================================================================
